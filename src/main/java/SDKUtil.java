/**
 * Created by durban126 on 16/7/13.
 */
...
public class SDKUtil {
     ...
     * 公钥文件路径
     */
    public static final String PUBLIC_KEY_PATH = "/Users/durban126/nodejs/qeeniao-wap-web/app/test/data/jiufu/9f_KDJZ_public.crt";

    /**
     * 私钥文件路径
     */
    public static final String PRIVATE_KEY_PATH = "/Users/durban126/nodejs/qeeniao-wap-web/app/test/data/jiufu/9f_KDJZ_private.pfx";
    ...
    public static void doLoadPrivateKey() {
        SDKUtil.loadPrivateKey(PRIVATE_KEY_PATH, PASSWORD);
    }

    public static void doLoadPublicKey() {
        SDKUtil.loadPublicKey(PUBLIC_KEY_PATH);
    }

    public static void main(String[] args) throws UnsupportedEncodingException, RuntimeException {

        PrivateKey qqstockPriKey = SDKUtil.loadPrivateKey(PRIVATE_KEY_PATH, PASSWORD);
        PublicKey qqstockPubKey = SDKUtil.loadPublicKey(PUBLIC_KEY_PATH);

        System.out.println("qqstockPriKey:" + Base64.encodeBase64String(qqstockPriKey.getEncoded()));
        System.out.println("qqstockPubKey:" + Base64.encodeBase64String(qqstockPubKey.getEncoded()));
        ...
        // 解密
        String decryptData = SDKUtil.decrypt(qqstockPubKey, encryptData);
